...
public interface SQLiteVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link SQLiteParser#windowFunction}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitWindowFunction(SQLiteParser.WindowFunctionContext ctx);
	/**
	 * Visit a parse tree produced by {@link SQLiteParser#offsetOptional}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOffsetOptional(SQLiteParser.OffsetOptionalContext ctx);
	/**
	 * Visit a parse tree produced by {@link SQLiteParser#defaultOptional}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDefaultOptional(SQLiteParser.DefaultOptionalContext ctx);
	/**
	 * Visit a parse tree produced by {@link SQLiteParser#partitionbyOptional}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPartitionbyOptional(SQLiteParser.PartitionbyOptionalContext ctx);
	/**
	 * Visit a parse tree produced by {@link SQLiteParser#orderByOptional}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOrderByOptional(SQLiteParser.OrderByOptionalContext ctx);
	/**
	 * Visit a parse tree produced by {@link SQLiteParser#exprAscDescOptional}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExprAscDescOptional(SQLiteParser.ExprAscDescOptionalContext ctx);
	/**
	 * Visit a parse tree produced by {@link SQLiteParser#ascdescOption}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAscdescOption(SQLiteParser.AscdescOptionContext ctx);
	/**
	 * Visit a parse tree produced by {@link SQLiteParser#frameclauseOptional}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFrameclauseOptional(SQLiteParser.FrameclauseOptionalContext ctx);
	/**
	 * Visit a parse tree produced by {@link SQLiteParser#frame_start}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFrame_start(SQLiteParser.Frame_startContext ctx);
	/**
	 * Visit a parse tree produced by {@link SQLiteParser#frame_end}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFrame_end(SQLiteParser.Frame_endContext ctx);
	/**
